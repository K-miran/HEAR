    ...
    */
    ...
    public:
        ...
        */
        ...
        // miran
        inline void encrypt_ckks(const Plaintext &plain, Ciphertext &destination,
            MemoryPoolHandle pool = MemoryManager::GetPool()) const
        {
            encrypt_internal_ckks(plain, true, false, destination, pool);
        }
