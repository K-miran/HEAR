    ...
    */
    ...
    public:
        ...
        */
        ...
        // miran: new_key -> sk
        inline void create_kswitch_keys(const std::uint64_t *new_keys, RelinKeys &destination)
        {
            auto &context_data = *context_->key_context_data();
            RelinKeys relin_keys;
            generate_kswitch_keys(new_keys, 1, static_cast<KSwitchKeys &>(relin_keys), false);
